...
const kDetailsScreenTitleText = "Detail Movie";
...
const kDrawerTitleFirstText = "SELECT THEME";
...
const KMainRed = Colors.red;
const KMainTeal = Colors.teal;
const kMainPinkColor = Color(0xFFE84CAF);

const kPrimaryColor = Color(0xff051139);
const kAppBarColor = Color(0xff051139);
const kLightGrey = Color(0xff52CDE8);
...
const kSearchAppBarColor = Color(0xff051139);
